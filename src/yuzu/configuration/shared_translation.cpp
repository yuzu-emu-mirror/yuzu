...
std::unique_ptr<TranslationShared::TranslationMap> TranslationShared::InitializeTranslations(QWidget* parent) {
...
std::unique_ptr<TranslationShared::ComboboxTranslationMap> TranslationShared::ComboboxEnumeration(QWidget* parent) {
