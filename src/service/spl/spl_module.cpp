...
#include "service/spl/csrng.h"
#include "service/spl/spl.h"
...
Result Module::Interface::GetConfigImpl(u64* out_config, ConfigItem config_item) const {
    ...
    case ConfigItem::ExosphereApiVersion:
        ...
        *out_config = (u64{Core::ApiVersion::ATMOSPHERE_RELEASE_VERSION_MAJOR} << 56) |
                      (u64{Core::ApiVersion::ATMOSPHERE_RELEASE_VERSION_MINOR} << 48) |
                      (u64{Core::ApiVersion::ATMOSPHERE_RELEASE_VERSION_MICRO} << 40) |
                      (static_cast<u64>(Core::ApiVersion::GetTargetFirmware()));
