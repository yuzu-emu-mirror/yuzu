...
Result AlbumManager::GetAlbumFileList(std::vector<ApplicationAlbumFileEntry>& out_entries,
                                      ContentType context_type, s64 start_posix_time,
    ...
    const auto result = GetAlbumFileList(album_entries, context_type, start_date, end_date, aruid);
...
Result AlbumManager::GetAlbumFileList(std::vector<ApplicationAlbumEntry>& out_entries,
                                      ContentType context_type, AlbumFileDateTime start_date,
