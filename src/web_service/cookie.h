...
public:
    ...
    static std::string SameSiteToString(SameSite samesite);

    static std::pair<std::string, std::string> NextPair(const std::string& text, size_t& position,
                                                        bool isNameValue);

    static std::vector<Cookie> ParseAllCookies(const std::string& cookieString);
    static std::vector<Cookie> ParseCookie(const std::string& cookieString);
